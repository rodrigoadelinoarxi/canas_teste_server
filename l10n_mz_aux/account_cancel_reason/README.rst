...
==========================
Account Cancel With Reason
==========================

Adds a popup when cancelling documents to give a reason for the status update.
Removes existing buttons that reset cancelled documents to a draft state.
...
* Bruno Francisco <bruno.francisco@arxi.pt>
